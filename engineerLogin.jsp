...
<div class="Login">
						...
						<form  action="engineerLoginSrv" method="post">
						<div>
							...
							<%}session.removeAttribute("flag"); %>
								...
								<div class="ticker">
									<h4>Username</h4>
						  			<input type="text" name="email" placeholder="Enter Email Id" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'John Smith';}" ><span> </span>
						  			<div class="clear"> </div>
						  		</div>
						  		<div>
						  		<h4>Password</h4>
